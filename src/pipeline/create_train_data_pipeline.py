...
import pyodbc
import json
from create_training_data.get_initial_data import DataFetcher
...
data_fetcher = DataFetcher(engine, nlp, collection)

df = data_fetcher.fetch_data_from_sql()
annotations = data_fetcher.process_data_through_spacy(df)
data_fetcher.save_to_local_directory(annotations, r'C:\Users\HP\Desktop\job_scan\pre_anootate_data')
data_fetcher.insert_into_mongodb(annotations)
